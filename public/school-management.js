...
// ===== SCHOOL ID GENERATION (Auto-generated by backend) =====
function regenerateSchoolId() {
  showAlert('info', 'School IDs are auto-generated by the system when you create a school. They follow the format: SCH-ABBREV-XXXXXX');
}
// ===== STATE MANAGEMENT =====
const AppState = {
  schools: [],
